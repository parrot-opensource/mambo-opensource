...
/** Private command ID to disable auto channel switch*/
#define WLAN_DISABLE_AUTO_CHAN_SWITCH		15
...
/** Private command ID for soft reset */
#define WLANSOFTRESET 				12
...
#define WLAN_CUSTOM_IE_CFG          (SIOCDEVPRIVATE + 13)
...
/** Private command ID to set/get CTS power control */
#define WLAN_CTS_POWER_CONTROL    		30
/** Private command ID to set/get IEEE PS mode */
#define WLAN_IEEE_PS_MODE			31
...
#define AUTHTYPE_OPEN				0
/** Authentication type : Shared */
#define AUTHTYPE_SHARED				1
/** Authentication type : Both open and shared */
#define AUTHTYPE_ALLOW_BOTH			2
