...
#define DRIVER_RELEASE_VERSION		"24609.p69"
#endif
#if LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,0)
#define DRIVER_RELEASE_VERSION		"26609.p69"
#endif
...
typedef struct _wlan_dbg
{
    ...
    /** Last event index */
    u16 LastEventIndex;
    /** Number of channel switch disassociation */
    u32 num_event_channel_switch;
} wlan_dbg;
...
/** IEEE PS mode: Null Packet */
#define IEEE_PS_MODE_NULLPKT    0
/** IEEE PS mode: PS-Poll */
#define IEEE_PS_MODE_PSPOLL     1
...
wlan_copy_mcast_addr(wlan_adapter * Adapter, struct net_device *dev)
{
    ...
    netdev_for_each_mc_addr(mcptr, dev)
        memcpy(&Adapter->MulticastList[i], mcptr->addr, ETH_ALEN);
#endif /* < 2.6.35 */
