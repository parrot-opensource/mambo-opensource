...
int wlan_radio_ioctl(wlan_private * priv, u16 option);
...
u8 wlan_rssi_to_quality(s16 rssi);
...
int wlan_enable_hs(wlan_private * priv);
int wlan_disable_hs(wlan_private * priv);
