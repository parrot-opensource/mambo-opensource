...
#if LINUX_VERSION_CODE < KERNEL_VERSION(2,5,0)
#define OS_INT_DISABLE(x,y)	cli()
#define OS_INT_RESTORE(x,y)	sti()
#else
...
#if LINUX_VERSION_CODE < KERNEL_VERSION(2,5,0)
#define MODULE_GET	MOD_INC_USE_COUNT
#define MODULE_PUT	MOD_DEC_USE_COUNT
#else
