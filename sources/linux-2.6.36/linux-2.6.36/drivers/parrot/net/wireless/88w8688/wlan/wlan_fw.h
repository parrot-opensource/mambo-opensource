...
/** Host Command ID : CTS power control */
#define HostCmd_CMD_CTS_POWER_CONTROL	      0x00e8
...
/** Host Subcommand ID : Enter power save (PS-Poll) */
#define HostCmd_SubCmd_Enter_PS_Poll          0x0037
...
/** Card Event definition : channel switch to new channel */
#define EVENT_CHAN_SWITCHED             0x00000045
...
typedef struct _MrvlIEtype_KeyParamSet_t
{
    ...
    /** Type of Key: WEP=0, TKIP=1, AES=2,WAPI=3*/
    u16 KeyTypeId;
...
typedef struct _custom_ie
{
    ...
    u16 ie_length;
    /** IE buffer */
    u8 ie_buffer[MAX_IE_SIZE];
} __ATTRIB_PACK__ custom_ie;

/** MGMT IE list support */
typedef struct _wlan_ioctl_custom_ie
{
    /** Type */
    u16 type;
    /** Length */
...
} __ATTRIB_PACK__ wlan_ioctl_custom_ie;
...
typedef struct _HostCmd_DS_MGMT_IE_LIST
{
    ...
    u16 action;
    /** Get/Set mgmt IE */
    wlan_ioctl_custom_ie ds_mgmt_ie;
} __ATTRIB_PACK__ HostCmd_DS_MGMT_IE_LIST_CFG;
...
typedef struct _HostCmd_DS_CTS_POWER_CONTROL
{
        /** Action */
    u16 Action;
        /** Power Control */
    u16 PowerCtrl;
} __ATTRIB_PACK__ HostCmd_DS_CTS_POWER_CONTROL;
...
struct _HostCmd_DS_COMMAND
{
    ...
    union
    {
        ...
        HostCmd_DS_CTS_POWER_CONTROL cts_power_ctrl;
    } params;
} __ATTRIB_PACK__;
